    ...
    <div class="container-fluid px-4">
        ...
        <div class="row my-5">
            ...
            <div class="col-xl-5 col-md-5 mt-3 border border-primary p-3 me-5">
                ...
                <span class="text-dark"><strong>Phone</strong> : +91 7575757589 </span><br>
                <span class="text-dark"><strong>Shipping Address</strong> : Lorem ipsum dolor, sit amet consectetur
                    adipisicing
                    elit. Quasi unde commodi itaque, beatae aperiam eius? </span><br>
            </div>
            <div class="col-xl-5 col-md-5 mt-3 border border-primary p-3">
                ...
                <span class="text-dark"><strong>Payment Status : </strong> <span
                        class="badge text-bg-success">Completed</span>
                </span><br>
                ...
                <table class="table" id="datatablesSimple">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>₹2000</td>
                            <td><a href="" class="btn btn-sm btn-primary">Shipped</a></td>
                            <td><a href="" class="btn btn-sm btn-primary">Shipped</a>
                                <a href="" class="btn btn-sm btn-success">Deleverd</a>
                        ...
                        <tr>
                            ...
                            <td>₹2000</td>
                            <td><a href="" class="btn btn-sm btn-success">Delevered</a></td>
                            <td><a href="" class="btn btn-sm btn-primary">Shipped</a>
                                <a href="" class="btn btn-sm btn-success">Deleverd</a>
                                <a href="{{ url('#') }}" class="btn btn-sm btn-danger">Cancel</a>
                            </td>
